...
/**
 * UtilRegistryViewModel class file
 * thunder.util.Registry的ViewModel
 *
 * @author 宋欢 <trotri@yeah.net>
 * @version $Id: UtilRegistryViewModel.java 1 2017-05-01 10:00:06Z huan.song $
 * @since 1.0
 */
public class UtilRegistryViewModel extends BaseViewModel {

    public static final String TAG = "UtilRegistryViewModel";
